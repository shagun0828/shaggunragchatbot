"""
Enhanced BGE Embedder for Phase 4.1
Enhanced BGE-small-en-v1.5 with financial domain adaptation
"""
...
class EnhancedBGEEembedder:
    """Enhanced BGE embedder with financial domain adaptation"""
    
    def __init__(self, base_model: str = "bge-small-en-v1.5"):
    ...
    def enhance_bge_embeddings(self, chunks: List[Chunk], base_embeddings: np.ndarray) -> np.ndarray:
        """Enhance BGE embeddings for financial domain with context awareness"""
        self.logger.info(f"Enhancing {len(chunks)} embeddings for financial domain using BGE")
    ...
    def batch_enhance_embeddings(self, chunks: List[Chunk], base_embeddings: np.ndarray, 
        ...
        for i in range(0, len(chunks), batch_size):
            ...
            batch_enhanced = self.enhance_bge_embeddings(batch_chunks, batch_embeddings)

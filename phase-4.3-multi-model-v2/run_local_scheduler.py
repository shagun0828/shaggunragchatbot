#!/usr/bin/env python3
"""
Quick Start Script for Local Scheduler
...
from src.logging_config import setup_global_logging


def print_banner():
    """Print startup banner"""
    print("=" * 80)
    print("PHASE 4.3 MULTI-MODEL INGEST PIPELINE - LOCAL SCHEDULER")
    print("=" * 80)
...
async def main():
    ...
    global_log_file = setup_global_logging()
    print(f"Global logging enabled: {global_log_file}")
    print()
    
    # Create and run scheduler
    print("Initializing local scheduler...")
